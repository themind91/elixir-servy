defmodule Servy.Handler do
  ...
  def route(conv) do
    ...
    #conv = %{method: request[:method], path: request[:path], resp_body: "Bears, Lions, Tigers"}
  ...
  def route(conv, "GET", "/bears/"<> id) do
    %{ conv | status: 200, resp_body: "Bear #{id} was found " }
  end


  def route(conv, "DELETE", "/bears/"<> id) do
    %{ conv | status: 200, resp_body: "Bear #{id} was deleted" }
  end
